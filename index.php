<?php 
include("koneksi.php");
$stid = oci_parse($koneksi, 'select count(*) as JUM from Buku_123');
oci_execute($stid);
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<?php 
				include("koneksi.php");
				$stid = oci_parse($koneksi, 'select count(*) as JUM from peminjam');
				oci_execute($stid);
				$total2 = oci_fetch_array($stid,OCI_BOTH);
			?>
				<div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <p class="card-category">Jumlah Peminjam</p>
               <h3 class="card-title"><?php echo $total2['JUM'];?>
			...
			<?php 
				include("koneksi.php");
				$stid = oci_parse($koneksi, 'select count(*) as JUM from Jurusan');
				oci_execute($stid);
				$total2 = oci_fetch_array($stid,OCI_BOTH);
			?>
				<div class="col-lg-3 col-md-6 col-sm-6">
